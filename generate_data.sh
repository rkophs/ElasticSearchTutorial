...
#Inspired by https://github.com/imotov/elasticsearch-test-scripts
...
'
curl -XPOST "${ADDR}/_bulk"  --data-binary '{"index":{"_index":"test-data","_type":"states","_id":"AL"}}
...
'
echo
curl -XPOST "${ADDR}/_bulk"  --data-binary '{"index":{"_index":"test-data","_type":"cities","_id":"1","_parent":"NY"}}
...
'
echo
echo "Generated Index: test-data"
echo "Generated Types: states, cities "
